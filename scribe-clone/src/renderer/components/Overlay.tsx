...
const Overlay: React.FC<OverlayProps> = ({ onStop, onPause, isPaused }) => {
  return (
    <div className="w-full h-full box-border overflow-hidden bg-[#404040]/90 backdrop-blur-md text-white px-4 py-3 rounded-2xl shadow-2xl flex items-center justify-between gap-4 border border-white/10 select-none">
      ...
      <div className="flex items-center gap-2 shrink-0">
        ...
        <button
          onClick={onStop}
          className="bg-red-500 hover:bg-red-600 p-2 rounded-xl transition-all hover:scale-105 shadow-lg shadow-red-500/20 shrink-0"
        >
